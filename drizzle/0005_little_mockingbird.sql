...
CREATE INDEX `walletTransactions_createdAt_idx` ON `walletTransactions` (`createdAt`);--> statement-breakpoint
CREATE INDEX `walletTransactions_reference_idx` ON `walletTransactions` (`referenceType`,`referenceId`);