 ...
 *
 * Before reader visibility is enabled, NQA runs a deterministic content hygiene
 * gate over episode plaintext/markdown. Safe tail remediation and visibility
 * activation commit in the same transaction. Unsupported or still-contaminated
 * content fails closed and remains unpublished.
 */
