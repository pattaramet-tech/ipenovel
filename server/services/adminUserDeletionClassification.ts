...
export const ADMIN_USER_DELETION_CLASSIFICATION: AdminUserDeletionColumnClassification[] = [
  ...
  { table: "accountMergeDataReconciliations", column: "actorAdminId", category: "audit_or_actor", reference: "Account Merge Data Receipts", reason: "This account performed an IPE-007 entitlement/user-data reconciliation whose attribution must remain durable." },
  { table: "accountMergeDataReconciliations", column: "sourceUserId", category: "audit_or_actor", reference: "Account Merge Data Receipts", reason: "This account was the Source recorded in an immutable data-reconciliation receipt." },
  { table: "accountMergeDataReconciliations", column: "targetUserId", category: "audit_or_actor", reference: "Account Merge Data Receipts", reason: "This account was the Target recorded in an immutable data-reconciliation receipt." },
  { table: "accountMergeCompensations", column: "donorUserId", category: "audit_or_actor", reference: "Historical Merge Compensations", reason: "This account was the canonical Donor recorded in an additive historical compensation lifecycle and must remain attributable." },
  { table: "accountMergeCompensations", column: "survivorUserId", category: "audit_or_actor", reference: "Historical Merge Compensations", reason: "This account was the canonical Survivor recorded in an additive historical compensation lifecycle and must remain attributable." },
  { table: "accountMergeCompensations", column: "createdByAdminId", category: "audit_or_actor", reference: "Historical Merge Compensations", reason: "This account created a historical compensation lifecycle whose administrative provenance must remain durable." },
  { table: "accountMergeCompensationReceipts", column: "donorUserId", category: "audit_or_actor", reference: "Historical Merge Compensation Receipts", reason: "This account is the canonical Donor recorded in an immutable compensation receipt." },
  { table: "accountMergeCompensationReceipts", column: "survivorUserId", category: "audit_or_actor", reference: "Historical Merge Compensation Receipts", reason: "This account is the canonical Survivor recorded in an immutable compensation receipt." },
  { table: "accountMergeCompensationAuditLogs", column: "actorAdminId", category: "audit_or_actor", reference: "Historical Merge Compensation Audit References", reason: "This account performed an audited historical compensation action whose attribution must survive." },
  { table: "workspaceWorkspaces", column: "ownerUserId", category: "user_owned", reference: "Workspace Ownership", reason: "Workspace ownership is durable user-owned collaboration state and blocks hard deletion." },
  ...
  { table: "workspaceEditorialWorkItemEvents", column: "fromAssigneeUserId", category: "audit_or_actor", reference: "Workspace Editorial Assignment Event References", reason: "The former assignee recorded in immutable assignment history must remain attributable." },
  { table: "workspaceEditorialWorkItemEvents", column: "toAssigneeUserId", category: "audit_or_actor", reference: "Workspace Editorial Assignment Event References", reason: "The destination assignee recorded in immutable assignment history must remain attributable." },
  { table: "workspaceEditorialSources", column: "createdByUserId", category: "audit_or_actor", reference: "Workspace Editorial Source Creator References", reason: "Editorial source creator identity is durable provenance that must survive hard-delete safety checks." },
  { table: "workspaceEditorialSourceSnapshots", column: "createdByUserId", category: "audit_or_actor", reference: "Workspace Editorial Source Snapshot Creator References", reason: "Immutable source-snapshot creator identity must remain attributable." },
  { table: "workspaceEditorialDrafts", column: "createdByUserId", category: "audit_or_actor", reference: "Workspace Editorial Draft Creator References", reason: "Editorial draft creator identity is durable provenance that must remain attributable." },
  { table: "workspaceEditorialDraftTransforms", column: "actorUserId", category: "audit_or_actor", reference: "Workspace Editorial Draft Transform Actors", reason: "Draft-transform actor identity is immutable edit provenance that must remain attributable." },
  { table: "workspaceEditorialDraftEditEvents", column: "actorUserId", category: "audit_or_actor", reference: "Workspace Editorial Draft Edit Actors", reason: "Manual draft-edit actor identity is immutable editorial audit provenance." },
  { table: "workspaceEditorialDraftApprovals", column: "approvedByUserId", category: "audit_or_actor", reference: "Workspace Editorial Approval Actors", reason: "Approval identity is immutable authorization evidence for an exact draft." },
  { table: "workspaceEditorialEpisodeStages", column: "stagedByUserId", category: "audit_or_actor", reference: "Workspace Editorial Episode Stage Actors", reason: "Episode-stage actor identity is immutable publication provenance that must remain attributable." },
  { table: "workspaceEditorialCheckerAllowWords", column: "createdByUserId", category: "audit_or_actor", reference: "Workspace Editorial Checker Policy Actors", reason: "Allow-list creator identity records who changed shared Workspace checker policy." },
  { table: "workspaceEditorialCheckerRuns", column: "createdByUserId", category: "audit_or_actor", reference: "Workspace Editorial Checker Run Actors", reason: "Checker-run creator identity is immutable execution provenance." },
  { table: "workspaceEditorialCheckerFindingStates", column: "actorUserId", category: "audit_or_actor", reference: "Workspace Editorial Finding State Actors", reason: "Finding-state actor identity records who resolved shared editorial evidence." },
  { table: "workspaceEditorialCheckerResolutionEvents", column: "actorUserId", category: "audit_or_actor", reference: "Workspace Editorial Resolution Event Actors", reason: "Checker-resolution event actor identity is immutable audit provenance." },
