...
const translations: Record<Language, Record<string, string>> = {
  th: {
    ...
    "payment.checkoutFailed": "อัปโหลดสลิปสำเร็จ แต่ไม่สามารถสร้างคำสั่งซื้อได้ กรุณาลองใหม่อีกครั้ง",
  ...
  en: {
    ...
    "payment.checkoutFailed": "Your slip was uploaded, but we couldn't create your order. Please try again.",
