...
const translations: Record<Language, Record<string, string>> = {
  th: {
    ...
    "payment.uploadNote": "หลังจากส่งสลิป ผู้ดูแลจะตรวจสอบและอนุมัติภายใน 24 ชั่วโมง",
    "payment.needHelp": "ต้องการความช่วยเหลือ?",
  ...
  en: {
    ...
    "payment.uploadNote": "After submission, admin will verify and approve within 24 hours",
