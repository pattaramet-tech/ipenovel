...
export const REQUIRED_COLUMN_SHAPES = [
  ...
  { table: "slipEvidenceUploads", column: "ownerUserId", columnType: "int", nullable: "NO", defaultValue: null },
  { table: "slipEvidenceUploads", column: "fileHash", columnType: "varchar(64)", nullable: "NO", defaultValue: null },
  { table: "slipEvidenceUploads", column: "objectSize", columnType: "int unsigned", nullable: "NO", defaultValue: null },
  { table: "slipEvidenceBindings", column: "uploadId", columnType: "int", nullable: "YES", defaultValue: null },
  { table: "slipEvidenceBindings", column: "sourceType", columnType: "enum('order_payment','wallet_topup')", nullable: "NO", defaultValue: null },
  { table: "slipEvidenceBindings", column: "sourceId", columnType: "int", nullable: "NO", defaultValue: null },
  { table: "slipEvidenceBindings", column: "ownerUserId", columnType: "int", nullable: "NO", defaultValue: null },
